console.log("Aqui está um fato sobre o Chuck Norris");
...
var random = Math.floor(Math.random() * tamanho_colecao);

console.log("Titulo", curiosidades[random].titulo);
console.log("Titulo", curiosidades[random].conteudo);